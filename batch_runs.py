...
for i in range(1,n+1):
    ...
    command = "python main.py --method modifiedBKKS21-123 --patient Paraspinal_Patient_2 --samples 3500000 --solver MOSEK 2>&1 | tee logs/mBSSK21-123_PS2_3500000_"+str(i)+".txt"
